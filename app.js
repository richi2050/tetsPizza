...
const access_token = "EAAeEM8tABzsBAAnYRUdWCQeQLQP8eXAqeBuSWsgukCITx5K9TkqgpOD73vOqhnf3sTO72IjtJDTXTuidX0Y6Unq6N3r2VsvRxHec0XZCVzKyAYjN8UY19Xit4W5kMKI8BZAiPsQG42zEUoZC3s0J3EPrnIFRVkuyC8VTWlEBAZDZD";

const app = express();

app.set('port', (process.env.PORT || 5000 )); //Se configura el puerto
app.use(bodyParser.json()); // asi se comunicaran y entenderemos los JSON que se comunicaran en nuestra App
...
app.get('/webhook', function(request, response){
    ...
    if(request.query['hub.verify_token'] === 'test_pizza_token'){
        //console.log(request.query);
        response.send(request.query['hub.challenge']);
    }else{
        response.send('No tienes permisos necesarios a esta aplicación');
    }
});
...
app.listen(app.get('port'),function(){
    console.log(" servicio comunicando",app.get('port'));
});